class InstallSolidQueueAndNotificationRecovery < ActiveRecord::Migration[8.1]
  def change
    ...
    add_column :notification_deliveries, :attempt_count, :integer, default: 0, null: false
    add_column :notification_deliveries, :last_attempt_at, :datetime
    add_index :notification_deliveries, [ :status, :updated_at ]
  end
end
